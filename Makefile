...
# podinfo-operator.io/podinfo-operator-bundle:$VERSION and podinfo-operator.io/podinfo-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= podinfo-operator.io/podinfo-operator
